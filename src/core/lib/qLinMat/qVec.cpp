...
template bool qVec<int>::equals(const qVec<int> &src) const;
template bool qVec<int>::equals(const qVec<long> &src) const;
template bool qVec<int>::equals(const qVec<float> &src) const;
template bool qVec<int>::equals(const qVec<double> &src) const;
...
template qVec<int>& qVec<int>::operator=(const qVec<int> &src);
template qVec<int>& qVec<int>::operator=(const qVec<double> &src);
template qVec<int>& qVec<int>::operator=(const qVec<long> &src);
template qVec<int>& qVec<int>::operator=(const qVec<float> &src);
template bool qVec<int>::operator==(const qVec<int> &other) const;
template bool qVec<int>::operator==(const qVec<double> &other) const;
template bool qVec<int>::operator==(const qVec<long> &other) const;
template bool qVec<int>::operator==(const qVec<float> &other) const;
template bool qVec<int>::operator!=(const qVec<int> &other) const;
template bool qVec<int>::operator!=(const qVec<double> &other) const;
template bool qVec<int>::operator!=(const qVec<long> &other) const;
template bool qVec<int>::operator!=(const qVec<float> &other) const;
...
template bool qVec<long>::equals(const qVec<int> &src) const;
template bool qVec<long>::equals(const qVec<long> &src) const;
template bool qVec<long>::equals(const qVec<float> &src) const;
template bool qVec<long>::equals(const qVec<double> &src) const;
...
template qVec<long>& qVec<long>::operator=(const qVec<int> &src);
template qVec<long>& qVec<long>::operator=(const qVec<double> &src);
template qVec<long>& qVec<long>::operator=(const qVec<long> &src);
template qVec<long>& qVec<long>::operator=(const qVec<float> &src);
template bool qVec<long>::operator==(const qVec<int> &other) const;
template bool qVec<long>::operator==(const qVec<double> &other) const;
template bool qVec<long>::operator==(const qVec<long> &other) const;
template bool qVec<long>::operator==(const qVec<float> &other) const;
template bool qVec<long>::operator!=(const qVec<int> &other) const;
template bool qVec<long>::operator!=(const qVec<double> &other) const;
template bool qVec<long>::operator!=(const qVec<long> &other) const;
template bool qVec<long>::operator!=(const qVec<float> &other) const;
...
template bool qVec<double>::equals(const qVec<int> &src) const;
template bool qVec<double>::equals(const qVec<long> &src) const;
template bool qVec<double>::equals(const qVec<float> &src) const;
template bool qVec<double>::equals(const qVec<double> &src) const;
...
template qVec<double>& qVec<double>::operator=(const qVec<int> &src);
template qVec<double>& qVec<double>::operator=(const qVec<double> &src);
template qVec<double>& qVec<double>::operator=(const qVec<long> &src);
template qVec<double>& qVec<double>::operator=(const qVec<float> &src);
template bool qVec<double>::operator==(const qVec<int> &other) const;
template bool qVec<double>::operator==(const qVec<double> &other) const;
template bool qVec<double>::operator==(const qVec<long> &other) const;
template bool qVec<double>::operator==(const qVec<float> &other) const;
template bool qVec<double>::operator!=(const qVec<int> &other) const;
template bool qVec<double>::operator!=(const qVec<double> &other) const;
template bool qVec<double>::operator!=(const qVec<long> &other) const;
template bool qVec<double>::operator!=(const qVec<float> &other) const;
...
template bool qVec<float>::equals(const qVec<int> &src) const;
template bool qVec<float>::equals(const qVec<long> &src) const;
template bool qVec<float>::equals(const qVec<float> &src) const;
template bool qVec<float>::equals(const qVec<double> &src) const;
...
template qVec<float>& qVec<float>::operator=(const qVec<int> &src);
template qVec<float>& qVec<float>::operator=(const qVec<double> &src);
template qVec<float>& qVec<float>::operator=(const qVec<long> &src);
template qVec<float>& qVec<float>::operator=(const qVec<float> &src);
template bool qVec<float>::operator==(const qVec<int> &other) const;
template bool qVec<float>::operator==(const qVec<double> &other) const;
template bool qVec<float>::operator==(const qVec<long> &other) const;
template bool qVec<float>::operator==(const qVec<float> &other) const;
template bool qVec<float>::operator!=(const qVec<int> &other) const;
template bool qVec<float>::operator!=(const qVec<double> &other) const;
template bool qVec<float>::operator!=(const qVec<long> &other) const;
template bool qVec<float>::operator!=(const qVec<float> &other) const;
...
/**
 * @brief Compares target qVec
 *
 * This function compares the given qVec to the current qVec
 *
 * @param src The qVec to compare to
 * @returns The boolean result
 */
template <typename T>
template <typename H>
bool qVec<T>::equals(const qVec<H> &src) const
{
    if ((void *)this == &src)
        return true;
    if (this->size != src.getSize())
        return false; // If sizes differ, vectors are not equal
    for (int i = 0; i < this->getSize(); ++i)
    {
        if (this->values[i] != src[i])
            return false; // If any element differs, vectors are not equal
    }
...
template <typename T>
template <typename H>
void qVec<T>::copy(const qVec<H> &src)
{
    if ((void *)this != &src) { // Avoid self-assignment by checking if the object is being assigned to itself
        delete[] this->values; // Free the currently allocated memory to prevent memory leaks
        this->values = nullptr;
        this->size = src.getSize();      // Copy the size of the source vector
        this->values = new T[this->size]; // Allocate new memory for the values
        for (int i = 0; i < this->size; ++i)
        {
            this->values[i] = src.getValue(i); // Copy each element from the source vector to the current vector
        }
    }
}
/**
...
/**
 * @brief Copies from source vector into current vector
 * 
 * This operator will copy from the RHS vector into the LHS vector
 * 
 * @tparam T the type of element in the LHS vector
 * @tparam H the type of element in the RHS vector
 * @param other A constant reference of the RHS vector
 * @return The LHS vector after the copy
 */
template<typename T>
template<typename H>
qVec<T>& qVec<T>::operator=(const qVec<H>& other) {
    this->copy(other);
    return *this;
}
template<typename T>
qVec<T>& qVec<T>::operator=(const qVec<T>& other) {
    this->copy(other);
    return *this;
}
/**
...
std::ostream &operator<<(std::ostream &os, const qVec<T> &vec)
{
    ...
    for (size_t i = 0; i < vec.getSize; ++i)
    {
        ...
        if (i < vec.getSize() - 1)
            os << ", "; // Separate values with a comma, except the last one
    }
